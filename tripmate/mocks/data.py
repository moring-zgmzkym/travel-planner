...
CITY_KB: dict[str, dict] = {
    ...
    "汉中": {
        "spots": ["汉中石门栈道", "勉县武侯祠", "古汉台", "兴汉胜境", "汉江湿地公园", "青木川古镇", "黎坪国家森林公园", "张骞墓"],
        "foods": ["汉中热面皮", "菜豆腐", "浆水面", "核桃馍", "梆梆面"],
        "routes": ["D1 石门栈道(上午)→古汉台(下午)→汉江边夜景(晚上)", "D2 勉县武侯祠→兴汉胜境→热面皮晚餐", "D3 青木川古镇或黎坪森林公园一日→返程"],
        "warnings": ["石门栈道景区较大，穿舒适的鞋", "武侯祠与武侯墓相邻，联票更划算", "陕南菜偏酸辣，口味可提前告知店家"],
        "tickets": {"汉中石门栈道": 70, "勉县武侯祠": 60, "兴汉胜境": 98, "青木川古镇": 60, "黎坪国家森林公园": 78, "张骞墓": 45, "古汉台": 0, "汉江湿地公园": 0},
        "landmark": "古汉台", "food_cost_per_day": 110,
    },
    "安康": {
        "spots": ["瀛湖风景区", "南宫山", "中坝大峡谷", "香溪洞", "汉江龙舟文化园", "燕翔洞"],
        "foods": ["蒸面", "炕炕馍", "浆水两掺面", "腊肉", "富硒茶"],
        "routes": ["D1 瀛湖乘船游湖(全天)→汉江边夜景", "D2 南宫山或中坝大峡谷一日→富硒茶体验", "D3 香溪洞→龙舟文化园→返程"],
        "warnings": ["瀛湖游船班次固定，上午到达为宜", "山区景点间车程较长，留足路途时间", "安康富硒茶适合带走，认准正规店铺"],
        "tickets": {"瀛湖风景区": 100, "南宫山": 90, "中坝大峡谷": 60, "香溪洞": 30, "燕翔洞": 65},
        "landmark": "汉江龙舟文化园", "food_cost_per_day": 100,
    },
    "商洛": {
        "spots": ["金丝峡景区", "牛背梁国家森林公园", "柞水溶洞", "塔云山", "棣花古镇"],
        "foods": ["商芝肉", "柞水腊肉", "搅团", "橡子凉粉", "核桃"],
        "routes": ["D1 柞水溶洞→牛背梁森林公园", "D2 金丝峡全天（陕南峡谷精华）", "D3 棣花古镇→塔云山→返程"],
        "warnings": ["金丝峡全程步行栈道约 4-5 小时，量力选择半程", "山区天气多变，备雨具", "柞水溶洞洞内温差大，带薄外套"],
        "tickets": {"金丝峡景区": 100, "牛背梁国家森林公园": 90, "柞水溶洞": 82, "塔云山": 70, "棣花古镇": 0},
        "landmark": "商洛市区", "food_cost_per_day": 95,
    },
}
